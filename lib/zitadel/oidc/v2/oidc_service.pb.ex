defmodule Zitadel.Oidc.V2.GetAuthRequestRequest do
...
defmodule Zitadel.Oidc.V2.GetAuthRequestResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.oidc.v2.AuthRequest",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field(:auth_request, 1, type: Zitadel.Oidc.V2.AuthRequest, json_name: "authRequest")
end

defmodule Zitadel.Oidc.V2.CreateCallbackRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.oidc.v2.Session",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "session",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.oidc.v2.AuthorizationError",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:auth_request_id, 1, type: :string, json_name: "authRequestId", deprecated: false)
  field(:session, 2, type: Zitadel.Oidc.V2.Session, oneof: 0)
  field(:error, 3, type: Zitadel.Oidc.V2.AuthorizationError, oneof: 0, deprecated: false)
end

defmodule Zitadel.Oidc.V2.Session do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Oidc.V2.CreateCallbackResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Oidc.V2.OIDCService.Service do
  use GRPC.Service, name: "zitadel.oidc.v2.OIDCService", protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.ServiceDescriptorProto{
      ...
      method: [
        %Google.Protobuf.MethodDescriptorProto{
          name: "GetAuthRequest",
          input_type: ".zitadel.oidc.v2.GetAuthRequestRequest",
          output_type: ".zitadel.oidc.v2.GetAuthRequestResponse",
          options: %Google.Protobuf.MethodOptions{
            ...
            __unknown_fields__: [
              {72_295_728, 2,
               <<18, 40, 47, 118, 50, 47, 111, 105, 100, 99, 47, 97, 117, 116, 104, 95, 114, 101,
                 113, 117, 101, 115, 116, 115, 47, 123, 97, 117, 116, 104, 95, 114, 101, 113, 117,
                 101, 115, 116, 95, 105, 100, 125>>},
              {50001, 2,
        ...
        %Google.Protobuf.MethodDescriptorProto{
          name: "CreateCallback",
          input_type: ".zitadel.oidc.v2.CreateCallbackRequest",
          output_type: ".zitadel.oidc.v2.CreateCallbackResponse",
          options: %Google.Protobuf.MethodOptions{
            deprecated: false,
            idempotency_level: :IDEMPOTENCY_UNKNOWN,
            uninterpreted_option: [],
            ...
            __unknown_fields__: [
              {72_295_728, 2,
               <<34, 40, 47, 118, 50, 47, 111, 105, 100, 99, 47, 97, 117, 116, 104, 95, 114, 101,
                 113, 117, 101, 115, 116, 115, 47, 123, 97, 117, 116, 104, 95, 114, 101, 113, 117,
                 101, 115, 116, 95, 105, 100, 125, 58, 1, 42>>},
              {50001, 2,
               <<10, 15, 10, 13, 97, 117, 116, 104, 101, 110, 116, 105, 99, 97, 116, 101, 100>>},
              {1042, 2,
  ...
  rpc(
    :GetAuthRequest,
    Zitadel.Oidc.V2.GetAuthRequestRequest,
    Zitadel.Oidc.V2.GetAuthRequestResponse
  )

  rpc(
    :CreateCallback,
    Zitadel.Oidc.V2.CreateCallbackRequest,
    Zitadel.Oidc.V2.CreateCallbackResponse
  )
end

defmodule Zitadel.Oidc.V2.OIDCService.Stub do
  use GRPC.Stub, service: Zitadel.Oidc.V2.OIDCService.Service
end
