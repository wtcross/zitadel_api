defmodule Zitadel.Oidc.V2beta.Prompt do
...
defmodule Zitadel.Oidc.V2beta.ErrorReason do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Oidc.V2beta.AuthRequest do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_ENUM,
          type_name: ".zitadel.oidc.v2beta.Prompt",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:prompt, 6,
    repeated: true,
    type: Zitadel.Oidc.V2beta.Prompt,
    enum: true,
    deprecated: false
  )
...
defmodule Zitadel.Oidc.V2beta.AuthorizationError do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.oidc.v2beta.ErrorReason",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "error",
  ...
  field(:error, 1, type: Zitadel.Oidc.V2beta.ErrorReason, enum: true)
