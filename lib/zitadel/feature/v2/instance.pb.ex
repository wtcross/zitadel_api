defmodule Zitadel.Feature.V2.SetInstanceFeaturesRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "SetInstanceFeaturesRequest",
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __unknown_fields__: [
              {1042, 2,
               <<50, 108, 69, 110, 97, 98, 108, 101, 32, 116, 104, 101, 32, 119, 101, 98, 107,
                 101, 121, 47, 118, 51, 97, 108, 112, 104, 97, 32, 65, 80, 73, 46, 32, 84, 104,
                 101, 32, 102, 105, 114, 115, 116, 32, 116, 105, 109, 101, 32, 116, 104, 105, 115,
                 32, 102, 101, 97, 116, 117, 114, 101, 32, 105, 115, 32, 101, 110, 97, 98, 108,
                 101, 100, 44, 32, 119, 101, 98, 32, 107, 101, 121, 115, 32, 97, 114, 101, 32,
                 103, 101, 110, 101, 114, 97, 116, 101, 100, 32, 97, 110, 100, 32, 97, 99, 116,
                 105, 118, 97, 116, 101, 100, 46, 74, 4, 116, 114, 117, 101>>}
            ]
          },
          oneof_index: 6,
          json_name: "webKey",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __unknown_fields__: [
              {1042, 2,
               <<50, 187, 1, 82, 101, 116, 117, 114, 110, 32, 112, 97, 114, 101, 110, 116, 32,
                 101, 114, 114, 111, 114, 115, 32, 116, 111, 32, 79, 73, 68, 67, 32, 99, 108, 105,
                 101, 110, 116, 115, 32, 102, 111, 114, 32, 100, 101, 98, 117, 103, 103, 105, 110,
                 103, 32, 112, 117, 114, 112, 111, 115, 101, 115, 46, 32, 80, 97, 114, 101, 110,
                 116, 32, 101, 114, 114, 111, 114, 115, 32, 109, 97, 121, 32, 99, 111, 110, 116,
                 97, 105, 110, 32, 115, 101, 110, 115, 105, 116, 105, 118, 101, 32, 100, 97, 116,
                 97, 32, 111, 114, 32, 117, 110, 119, 97, 110, 116, 101, 100, 32, 100, 101, 116,
                 97, 105, 108, 115, 32, 97, 98, 111, 117, 116, 32, 116, 104, 101, 32, 115, 121,
                 115, 116, 101, 109, 32, 115, 116, 97, 116, 117, 115, 32, 111, 102, 32, 122, 105,
                 116, 97, 100, 101, 108, 46, 32, 79, 110, 108, 121, 32, 101, 110, 97, 98, 108,
                 101, 32, 105, 102, 32, 114, 101, 97, 108, 108, 121, 32, 110, 101, 101, 100, 101,
                 100, 46, 74, 4, 116, 114, 117, 101>>}
            ]
          },
          oneof_index: 7,
          json_name: "debugOidcParentError",
          proto3_optional: true,
          __unknown_fields__: []
        },
        %Google.Protobuf.FieldDescriptorProto{
  ...
  field(:web_key, 8, proto3_optional: true, type: :bool, json_name: "webKey", deprecated: false)

  field(:debug_oidc_parent_error, 9,
    proto3_optional: true,
    type: :bool,
    json_name: "debugOidcParentError",
    deprecated: false
  ...
  field(:oidc_single_v1_session_termination, 10,
    proto3_optional: true,
    type: :bool,
    json_name: "oidcSingleV1SessionTermination",
    deprecated: false
...
defmodule Zitadel.Feature.V2.SetInstanceFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "SetInstanceFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
...
defmodule Zitadel.Feature.V2.ResetInstanceFeaturesRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "ResetInstanceFeaturesRequest",
      field: [],
      nested_type: [],
      enum_type: [],
      extension_range: [],
...
defmodule Zitadel.Feature.V2.ResetInstanceFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "ResetInstanceFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
...
defmodule Zitadel.Feature.V2.GetInstanceFeaturesRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "GetInstanceFeaturesRequest",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "inheritance",
          extendee: nil,
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __unknown_fields__: [
              {1042, 2,
               <<50, 209, 2, 73, 110, 104, 101, 114, 105, 116, 32, 117, 110, 115, 101, 116, 32,
                 ...
                 105, 110, 115, 116, 97, 110, 99, 101, 44, 32, 105, 116, 32, 119, 105, 108, 108,
                 32, 98, 101, 32, 111, 109, 105, 116, 116, 101, 100, 32, 102, 114, 111, 109, 32,
                 116, 104, 101, 32, 114, 101, 115, 112, 111, 110, 115, 101, 32, 111, 114, 32, 78,
                 111, 116, 32, 70, 111, 117, 110, 100, 32, 105, 115, 32, 114, 101, 116, 117, 114,
                 110, 101, 100, 32, 119, 104, 101, 110, 32, 116, 104, 101, 32, 105, 110, 115, 116,
                 97, 110, 99, 101, 32, 104, 97, 115, 32, 110, 111, 32, 102, 101, 97, 116, 117,
                 114, 101, 115, 32, 102, 108, 97, 103, 115, 32, 97, 116, 32, 97, 108, 108, 46, 74,
                 4, 116, 114, 117, 101>>}
            ]
          },
          oneof_index: nil,
  ...
  field(:inheritance, 1, type: :bool, deprecated: false)
end

defmodule Zitadel.Feature.V2.GetInstanceFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "GetInstanceFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.feature.v2.FeatureFlag",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.feature.v2.ImprovedPerformanceFeatureFlag",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:login_default_org, 2,
    type: Zitadel.Feature.V2.FeatureFlag,
    json_name: "loginDefaultOrg",
    deprecated: false
  )
  ...
  field(:actions, 7, type: Zitadel.Feature.V2.FeatureFlag, deprecated: false)

  field(:improved_performance, 8,
    type: Zitadel.Feature.V2.ImprovedPerformanceFeatureFlag,
    json_name: "improvedPerformance",
    deprecated: false
  )

  field(:web_key, 9, type: Zitadel.Feature.V2.FeatureFlag, json_name: "webKey", deprecated: false)

  field(:debug_oidc_parent_error, 10,
    type: Zitadel.Feature.V2.FeatureFlag,
    json_name: "debugOidcParentError",
    deprecated: false
  )

  field(:oidc_single_v1_session_termination, 11,
    type: Zitadel.Feature.V2.FeatureFlag,
    json_name: "oidcSingleV1SessionTermination",
    deprecated: false
  )
