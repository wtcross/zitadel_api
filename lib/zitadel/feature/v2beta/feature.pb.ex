defmodule Zitadel.Feature.V2beta.Source do
...
defmodule Zitadel.Feature.V2beta.ImprovedPerformance do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Feature.V2beta.FeatureFlag do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.feature.v2beta.Source",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:source, 2, type: Zitadel.Feature.V2beta.Source, enum: true, deprecated: false)
end

defmodule Zitadel.Feature.V2beta.ImprovedPerformanceFeatureFlag do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
