defmodule Zitadel.Feature.V2beta.SetUserFeatureRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "SetUserFeatureRequest",
      field: [
...
defmodule Zitadel.Feature.V2beta.SetUserFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "SetUserFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
...
defmodule Zitadel.Feature.V2beta.ResetUserFeaturesRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "ResetUserFeaturesRequest",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "user_id",
          extendee: nil,
...
defmodule Zitadel.Feature.V2beta.ResetUserFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "ResetUserFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
...
defmodule Zitadel.Feature.V2beta.GetUserFeaturesRequest do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "GetUserFeaturesRequest",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "user_id",
          extendee: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __unknown_fields__: [
              {1042, 2,
               <<50, 202, 2, 73, 110, 104, 101, 114, 105, 116, 32, 117, 110, 115, 101, 116, 32,
                 ...
                 117, 115, 101, 114, 44, 32, 105, 116, 32, 119, 105, 108, 108, 32, 98, 101, 32,
                 111, 109, 109, 105, 116, 116, 101, 100, 32, 102, 114, 111, 109, 32, 116, 104,
                 101, 32, 114, 101, 115, 112, 111, 110, 115, 101, 32, 111, 114, 32, 78, 111, 116,
                 32, 70, 111, 117, 110, 100, 32, 105, 115, 32, 114, 101, 116, 117, 114, 110, 101,
                 100, 32, 119, 104, 101, 110, 32, 116, 104, 101, 32, 117, 115, 101, 114, 32, 104,
                 97, 115, 32, 110, 111, 32, 102, 101, 97, 116, 117, 114, 101, 115, 32, 102, 108,
                 97, 103, 115, 32, 97, 116, 32, 97, 108, 108, 46, 74, 4, 116, 114, 117, 101>>}
            ]
          },
          oneof_index: nil,
...
defmodule Zitadel.Feature.V2beta.GetUserFeaturesResponse do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"

  def descriptor do
    # credo:disable-for-next-line
    %Google.Protobuf.DescriptorProto{
      name: "GetUserFeaturesResponse",
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          name: "details",
          extendee: nil,
