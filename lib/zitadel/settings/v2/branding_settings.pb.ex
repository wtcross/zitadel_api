defmodule Zitadel.Settings.V2.ThemeMode do
...
defmodule Zitadel.Settings.V2.BrandingSettings do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.settings.v2.Theme",
          default_value: nil,
          options: nil,
          oneof_index: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.settings.v2.ThemeMode",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:light_theme, 1, type: Zitadel.Settings.V2.Theme, json_name: "lightTheme")
  field(:dark_theme, 2, type: Zitadel.Settings.V2.Theme, json_name: "darkTheme")
  ...
  field(:theme_mode, 7,
    type: Zitadel.Settings.V2.ThemeMode,
    json_name: "themeMode",
    enum: true,
    deprecated: false
  )
...
defmodule Zitadel.Settings.V2.Theme do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
