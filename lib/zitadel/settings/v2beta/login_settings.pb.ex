defmodule Zitadel.Settings.V2beta.SecondFactorType do
...
defmodule Zitadel.Settings.V2beta.MultiFactorType do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Settings.V2beta.PasskeysType do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Settings.V2beta.IdentityProviderType do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Settings.V2beta.LoginSettings do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.settings.v2beta.PasskeysType",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_ENUM,
          type_name: ".zitadel.settings.v2beta.SecondFactorType",
          default_value: nil,
          options: nil,
          oneof_index: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_ENUM,
          type_name: ".zitadel.settings.v2beta.MultiFactorType",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field(:passkeys_type, 5,
    type: Zitadel.Settings.V2beta.PasskeysType,
    json_name: "passkeysType",
    enum: true,
    deprecated: false
  )
  ...
  field(:second_factors, 14,
    repeated: true,
    type: Zitadel.Settings.V2beta.SecondFactorType,
    json_name: "secondFactors",
    enum: true
  )
  ...
  field(:multi_factors, 15,
    repeated: true,
    type: Zitadel.Settings.V2beta.MultiFactorType,
    json_name: "multiFactors",
    enum: true
  )
...
defmodule Zitadel.Settings.V2beta.IdentityProvider do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.settings.v2beta.IdentityProviderType",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "type",
  ...
  field(:type, 3, type: Zitadel.Settings.V2beta.IdentityProviderType, enum: true)
end
