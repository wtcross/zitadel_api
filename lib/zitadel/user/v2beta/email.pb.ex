defmodule Zitadel.User.V2beta.SetHumanEmail do
...
defmodule Zitadel.User.V2beta.HumanEmail do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.SendEmailVerificationCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.ReturnEmailVerificationCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
