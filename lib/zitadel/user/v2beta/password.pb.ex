defmodule Zitadel.User.V2beta.NotificationType do
...
defmodule Zitadel.User.V2beta.Password do
...
defmodule Zitadel.User.V2beta.HashedPassword do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.SendPasswordResetLink do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.user.v2beta.NotificationType",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field(:notification_type, 1,
    type: Zitadel.User.V2beta.NotificationType,
    json_name: "notificationType",
    enum: true
  )
...
defmodule Zitadel.User.V2beta.ReturnPasswordResetCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.SetPassword do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
  ...
  field(:password, 1, type: Zitadel.User.V2beta.Password, oneof: 0)
