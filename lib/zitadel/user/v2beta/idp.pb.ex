defmodule Zitadel.User.V2beta.LDAPCredentials do
...
defmodule Zitadel.User.V2beta.RedirectURLs do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.IDPIntent do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.IDPInformation do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.user.v2beta.IDPOAuthAccessInformation",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.user.v2beta.IDPLDAPAccessInformation",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.user.v2beta.IDPSAMLAccessInformation",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:oauth, 1,
    type: Zitadel.User.V2beta.IDPOAuthAccessInformation,
    oneof: 0,
    deprecated: false
  )

  field(:ldap, 6, type: Zitadel.User.V2beta.IDPLDAPAccessInformation, oneof: 0, deprecated: false)
  field(:saml, 7, type: Zitadel.User.V2beta.IDPSAMLAccessInformation, oneof: 0, deprecated: false)
...
defmodule Zitadel.User.V2beta.IDPOAuthAccessInformation do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.IDPLDAPAccessInformation do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.IDPSAMLAccessInformation do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.IDPLink do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
