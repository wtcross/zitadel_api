defmodule Zitadel.User.V2beta.PasskeyAuthenticator do
...
defmodule Zitadel.User.V2beta.SendPasskeyRegistrationLink do
...
defmodule Zitadel.User.V2beta.ReturnPasskeyRegistrationCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.User.V2beta.PasskeyRegistrationCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
