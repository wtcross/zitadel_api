defmodule Zitadel.Session.V2.UserVerificationRequirement do
...
defmodule Zitadel.Session.V2.RequestChallenges.WebAuthN do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".zitadel.session.v2.UserVerificationRequirement",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:user_verification_requirement, 2,
    type: Zitadel.Session.V2.UserVerificationRequirement,
    json_name: "userVerificationRequirement",
    enum: true,
    deprecated: false
  )
...
defmodule Zitadel.Session.V2.RequestChallenges.OTPSMS do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2.RequestChallenges.OTPEmail.SendCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2.RequestChallenges.OTPEmail.ReturnCode do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2.RequestChallenges.OTPEmail do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.RequestChallenges.OTPEmail.SendCode",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "sendCode",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.RequestChallenges.OTPEmail.ReturnCode",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "returnCode",
  ...
  field(:send_code, 2,
    type: Zitadel.Session.V2.RequestChallenges.OTPEmail.SendCode,
    json_name: "sendCode",
    oneof: 0
  )

  field(:return_code, 3,
    type: Zitadel.Session.V2.RequestChallenges.OTPEmail.ReturnCode,
    json_name: "returnCode",
    oneof: 0
  )
end

defmodule Zitadel.Session.V2.RequestChallenges do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.RequestChallenges.WebAuthN",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "webAuthN",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.RequestChallenges.OTPSMS",
          default_value: nil,
          options: nil,
          oneof_index: 1,
          json_name: "otpSms",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.RequestChallenges.OTPEmail",
          default_value: nil,
          options: nil,
          oneof_index: 2,
          json_name: "otpEmail",
  ...
  field(:web_auth_n, 1,
    proto3_optional: true,
    type: Zitadel.Session.V2.RequestChallenges.WebAuthN,
    json_name: "webAuthN"
  )

  field(:otp_sms, 2,
    proto3_optional: true,
    type: Zitadel.Session.V2.RequestChallenges.OTPSMS,
    json_name: "otpSms"
  )

  field(:otp_email, 3,
    proto3_optional: true,
    type: Zitadel.Session.V2.RequestChallenges.OTPEmail,
    json_name: "otpEmail"
  )
end

defmodule Zitadel.Session.V2.Challenges.WebAuthN do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2.Challenges do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2.Challenges.WebAuthN",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "webAuthN",
  ...
  field(:web_auth_n, 1,
    proto3_optional: true,
    type: Zitadel.Session.V2.Challenges.WebAuthN,
    json_name: "webAuthN"
  )
