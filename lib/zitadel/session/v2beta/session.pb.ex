defmodule Zitadel.Session.V2beta.SessionFieldName do
...
defmodule Zitadel.Session.V2beta.Session.MetadataEntry do
...
defmodule Zitadel.Session.V2beta.Session do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.Factors",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.Session.MetadataEntry",
          default_value: nil,
          options: %Google.Protobuf.FieldOptions{
            ctype: :STRING,
            packed: nil,
  ...
  field(:factors, 5, type: Zitadel.Session.V2beta.Factors, deprecated: false)

  field(:metadata, 6,
    repeated: true,
    type: Zitadel.Session.V2beta.Session.MetadataEntry,
    map: true,
    deprecated: false
  )

  field(:user_agent, 7, type: Zitadel.Session.V2beta.UserAgent, json_name: "userAgent")
...
defmodule Zitadel.Session.V2beta.Factors do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.UserFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "user",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.PasswordFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "password",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.WebAuthNFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "webAuthN",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.IntentFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "intent",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.TOTPFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "totp",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.OTPFactor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "otpSms",
  ...
  field(:user, 1, type: Zitadel.Session.V2beta.UserFactor)
  field(:password, 2, type: Zitadel.Session.V2beta.PasswordFactor)
  field(:web_auth_n, 3, type: Zitadel.Session.V2beta.WebAuthNFactor, json_name: "webAuthN")
  field(:intent, 4, type: Zitadel.Session.V2beta.IntentFactor)
  field(:totp, 5, type: Zitadel.Session.V2beta.TOTPFactor)
  field(:otp_sms, 6, type: Zitadel.Session.V2beta.OTPFactor, json_name: "otpSms")
  field(:otp_email, 7, type: Zitadel.Session.V2beta.OTPFactor, json_name: "otpEmail")
end

defmodule Zitadel.Session.V2beta.UserFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.PasswordFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.IntentFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.WebAuthNFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.TOTPFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.OTPFactor do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.SearchQuery do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.IDsQuery",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "idsQuery",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.UserIDQuery",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.CreationDateQuery",
          default_value: nil,
          options: nil,
          oneof_index: 0,
  ...
  field(:ids_query, 1, type: Zitadel.Session.V2beta.IDsQuery, json_name: "idsQuery", oneof: 0)

  field(:user_id_query, 2,
    type: Zitadel.Session.V2beta.UserIDQuery,
    json_name: "userIdQuery",
    oneof: 0
  )

  field(:creation_date_query, 3,
    type: Zitadel.Session.V2beta.CreationDateQuery,
    json_name: "creationDateQuery",
    oneof: 0
  )
end

defmodule Zitadel.Session.V2beta.IDsQuery do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.UserIDQuery do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.CreationDateQuery do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.UserAgent.HeaderValues do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Session.V2beta.UserAgent.HeaderEntry do
  use Protobuf, map: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.UserAgent.HeaderValues",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "value",
  ...
  field(:key, 1, type: :string)
  field(:value, 2, type: Zitadel.Session.V2beta.UserAgent.HeaderValues)
end

defmodule Zitadel.Session.V2beta.UserAgent do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".zitadel.session.v2beta.UserAgent.HeaderEntry",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "header",
  ...
  field(:header, 4, repeated: true, type: Zitadel.Session.V2beta.UserAgent.HeaderEntry, map: true)
end
