defmodule Zitadel.Object.V2beta.TextQueryMethod do
...
defmodule Zitadel.Object.V2beta.ListQueryMethod do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Object.V2beta.TimestampQueryMethod do
  use Protobuf, enum: true, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Object.V2beta.Organisation do
  ...
  def descriptor do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      options: nil,
      oneof_decl: [
        %Google.Protobuf.OneofDescriptorProto{name: "org", options: nil, __unknown_fields__: []}
      ],
      reserved_range: [],
      reserved_name: [],
      __unknown_fields__: []
  ...
  field(:org_id, 1, type: :string, json_name: "orgId", oneof: 0)
  field(:org_domain, 2, type: :string, json_name: "orgDomain", oneof: 0)
end

defmodule Zitadel.Object.V2beta.Organization do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Object.V2beta.RequestContext do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
  ...
  oneof(:resource_owner, 0)

  field(:org_id, 1, type: :string, json_name: "orgId", oneof: 0)
  field(:instance, 2, type: :bool, oneof: 0, deprecated: false)
end

defmodule Zitadel.Object.V2beta.ListQuery do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
...
defmodule Zitadel.Object.V2beta.Details do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
  ...
  field(:change_date, 2, type: Google.Protobuf.Timestamp, json_name: "changeDate")
  field(:resource_owner, 3, type: :string, json_name: "resourceOwner", deprecated: false)
end

defmodule Zitadel.Object.V2beta.ListDetails do
  use Protobuf, syntax: :proto3, protoc_gen_elixir_version: "0.12.0"
