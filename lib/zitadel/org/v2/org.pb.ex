defmodule Zitadel.Org.V2.OrganizationState do
    ...
    %Google.Protobuf.EnumDescriptorProto{
      ...
      value: [
        %Google.Protobuf.EnumValueDescriptorProto{
          name: "ORGANIZATION_STATE_UNSPECIFIED",
          number: 0,
          options: nil,
          __unknown_fields__: []
        },
        %Google.Protobuf.EnumValueDescriptorProto{
          name: "ORGANIZATION_STATE_ACTIVE",
          number: 1,
          options: nil,
          __unknown_fields__: []
        },
        %Google.Protobuf.EnumValueDescriptorProto{
          name: "ORGANIZATION_STATE_INACTIVE",
          number: 2,
          options: nil,
          __unknown_fields__: []
        },
        %Google.Protobuf.EnumValueDescriptorProto{
          name: "ORGANIZATION_STATE_REMOVED",
          number: 3,
          options: nil,
          __unknown_fields__: []
        }
  ...
  field(:ORGANIZATION_STATE_UNSPECIFIED, 0)
  field(:ORGANIZATION_STATE_ACTIVE, 1)
  field(:ORGANIZATION_STATE_INACTIVE, 2)
  field(:ORGANIZATION_STATE_REMOVED, 3)
end

defmodule Zitadel.Org.V2.Organization do
  ...
  field(:state, 3, type: Zitadel.Org.V2.OrganizationState, enum: true)
